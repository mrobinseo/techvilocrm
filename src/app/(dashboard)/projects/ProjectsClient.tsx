      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Dialog open={isDialogOpen} onOpenChange={(open) => {
            ...
            if (!open) setIsCustomService(false)
          }}>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Select name="service" onValueChange={(val) => setIsCustomService(val === 'Custom')} required>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select name="client" defaultValue={editProject?.client_id} required>
                    <SelectTrigger className="bg-zinc-900 border-zinc-800 text-white">
                      <SelectValue placeholder="Select client" />
                    </SelectTrigger>
                    <SelectContent className="bg-zinc-900 border-zinc-800 text-zinc-100 max-h-[200px]">
                ...
                <div className="grid gap-2">
                  ...
                  <Select name="service" defaultValue={editProject?.service} onValueChange={(val) => setIsCustomService(val === 'Custom')} required>
                    <SelectTrigger className="bg-zinc-900 border-zinc-800 text-zinc-100">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-zinc-900 border-zinc-800 text-zinc-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select name="billing" defaultValue={editProject?.billing_type}>
                    <SelectTrigger className="bg-zinc-900 border-zinc-800 text-zinc-100">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-zinc-900 border-zinc-800 text-zinc-100">
