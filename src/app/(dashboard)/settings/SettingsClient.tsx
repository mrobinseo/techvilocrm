...
import { Plus, UserPlus, Shield, UserCog, User, Trash2, AlertTriangle, Key } from "lucide-react"
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Input name="password" id="password" type="text" placeholder="Set a password" className="bg-zinc-900 border-zinc-800 text-white pr-9" required />
                    <Key className="absolute right-3 top-2.5 size-4 text-zinc-500" />
                  </div>
                </div>
                <div className="grid gap-2">
