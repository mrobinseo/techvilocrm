            ...
            <DialogContent className="sm:max-w-[425px] bg-zinc-950 border-zinc-800 text-zinc-100">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input name="email" id="email" type="email" placeholder="john@example.com" className="bg-zinc-900 border-zinc-800 text-zinc-100 focus-visible:ring-indigo-500/50" required />
                </div>
                <div className="grid gap-2">
          ...
          <form onSubmit={handleEditSubmit}>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Input name="email" id="edit-email" type="email" defaultValue={editClient?.email} className="bg-zinc-900 border-zinc-800 text-zinc-100" required />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Select name="status" defaultValue={editClient?.status}>
        ...
        <DialogContent className="sm:max-w-[400px] bg-zinc-950 border-zinc-800 text-zinc-100">
          <DialogHeader>
            ...
            <DialogDescription className="text-zinc-400 pt-3">
              Are you sure you want to delete this client? This action cannot be undone and will remove all associated projects and records.
            </DialogDescription>
          </DialogHeader>
